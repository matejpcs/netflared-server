...
The release workflow builds every listed Paper API independently. It publishes three GitHub Releases per plugin release version, one for each compatibility branch, with one JAR per supported Paper version.
